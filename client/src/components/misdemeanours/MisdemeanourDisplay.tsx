...
const MisdemeanourDisplay : React.FC = () => {    
    ...
    <div className="container">
        ...
        <p className="misdemeanour__message">For United fans there can be <strong>no forgiveness</strong> until you perform a <span className="text--lfc">Liverpool</span> song of our choice at a public ceremony - contact us for details.</p>
        </details>
    </div>
    <MisdemeanourTable />
